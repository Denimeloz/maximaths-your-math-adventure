...
const College = () => {
  ...
  const levels: { id: CourseLevel | 'all'; label: string; color: string }[] = [
    ...
    { id: '6eme', label: '6ème', color: 'bg-rainbow-blue' },
    { id: '5eme', label: '5ème', color: 'bg-rainbow-green' },
    { id: '4eme', label: '4ème', color: 'bg-rainbow-orange' },
    { id: '3eme', label: '3ème', color: 'bg-rainbow-coral' },
  ];
  ...
  const getLevelColor = (level: CourseLevel) => {
    const colors: Record<CourseLevel, string> = {
      '6eme': 'border-rainbow-blue/30 hover:border-rainbow-blue',
      '5eme': 'border-rainbow-green/30 hover:border-rainbow-green',
      '4eme': 'border-rainbow-orange/30 hover:border-rainbow-orange',
      '3eme': 'border-rainbow-coral/30 hover:border-rainbow-coral',
    };
    return colors[level];
  };
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-rainbow-blue/20 rounded-full mb-6">
            <GraduationCap className="w-5 h-5 text-rainbow-blue" />
            <span className="text-rainbow-blue font-body font-semibold">Niveau Collège</span>
          </div>
          
          <h1 className="text-4xl md:text-5xl font-display text-foreground mb-4">
            Cours de Mathématiques
            <span className="text-rainbow"> Collège</span>
          </h1>
          
          <p className="text-xl text-muted-foreground font-body max-w-2xl mx-auto">
            De la 6ème à la 3ème, découvre tous les cours adaptés à ton niveau !
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          /* Empty State */
          <div className="card-sticker bg-card border-rainbow-blue/30 p-12 text-center max-w-xl mx-auto">
            <BookOpen className="w-20 h-20 mx-auto mb-6 text-rainbow-blue opacity-50" />
